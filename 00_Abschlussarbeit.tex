...
\hypersetup{
	...
	filecolor			= magenta,
	urlcolor			= cyan,
	pdftitle			= {Thesis Tim Nieter},
	pdfauthor			= Tim Nieter,
	pdfsubject			= {Entwicklung eines vollautomatisierten Embedded-Linux-Systems zur Ansteuerung und Auswertung eines Langzeittests},
...
% 
\hyphenation{Da-ten-bank-manage-ment-sys-tem}
%%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% G L O S S A R %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\include{30_Konzeptentwicklung}
\include{Implementierung}
\include{40_Testen_und_Validieren}
\include{FazitUndAusblick}
%%%
%%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
