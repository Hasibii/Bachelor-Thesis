...
Das Herzstück des Mess-Clients (siehe Abbildung \ref{figure_DegraBoardBottom} und \ref{figure_DegraBoardTop})  bildet ein STM8 8-Bit Mikrocontroller der Firma STMicroelectronics.
...
Jedes dieser Mess-Clients wird vor dem Betrieb parametriert.
