...
Des Weiteren steuert er die Prüfobjekte mit einem Pulsmuster (englisch: pulse pattern) an. Dieses Muster ist konfigurierbar und wird an die unterschiedlichen Prüfobjekte angepasst. Ein Pulsmuster besteht aus bis zu 20 verschiedenen Impulsen, die periodisch wiederholt werden.\\
\begin{figure}[H]
\begin{center}
...
Außerdem ist die Vorverstärkung der \ac{ADC}, die die optischen Sensoren auslesen, konfigurierbar. Da verschiedene Prüfobjekte auch unterschiedliche Leistungsmerkmale besitzen, werden damit die gemessenen Größen normalisiert.
